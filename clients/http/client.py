...
class HTTPClient:
    ...
    def get(self, url: URL | str, params: QueryParams | None = None, extensions: HTTPClientExtensions | None = None) -> Response:       # 7.3.4
    ...
    def post(self, url: URL | str, json: Any | None = None, extensions: HTTPClientExtensions | None = None) -> Response:
