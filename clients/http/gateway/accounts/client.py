...
from clients.http.gateway.accounts.schema import (GetAccountsQuerySchema, GetAccountsResponseSchema,
                                                  OpenCreditCardAccountRequestSchema, OpenDepositAccountResponseSchema,
                                                  OpenCreditCardAccountResponseSchema, OpenSavingsAccountResponseSchema,
                                                  OpenDebitCardAccountResponseSchema, OpenDepositAccountRequestSchema,
...
class AccountsGatewayHTTPClient(HTTPClient):
    ...
    def get_accounts_api(self, query: GetAccountsQuerySchema) -> Response:
        ...
        return self.get("/api/v1/accounts", params=QueryParams(**query.model_dump(by_alias=True)))  # 7.4.3
